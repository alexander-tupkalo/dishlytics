...
const TRANSLATIONS = {
  en: {
    ...
    /* ── Invoice scanner — missing keys ── */
    inv_processing_title:'AI is reading your invoice…',
    inv_review_sub:'Review detected price changes',
    inv_review_disclaimer:'AI extraction may contain errors. Always verify prices before confirming.',
    inv_col_product:'Product', inv_col_old:'Old Price',
    inv_col_new:'New Price', inv_col_change:'Change',
    inv_stat_updated:'Prices Updated', inv_stat_last:'Last Scan',
    inv_old_price:'Old Price', inv_new_price:'New Price', inv_change:'Change',
    inv_processing:'AI is reading your invoice…',
    scan_processing_title:'AI is reading your invoice…',
    scan_processing_sub:'This takes a few seconds',
    scan_result_title:'Invoice Scan Complete',
    scan_result_items_found:' price change(s) detected',
    scan_col_product:'Product', scan_col_old:'Old', scan_col_new:'New', scan_col_diff:'Change',
    scan_confirm_btn:'Confirm & Update All', scan_cancel_btn:'Cancel',
    scan_select_all:'Select all changes',
    scan_disclaimer:'AI extraction may contain errors.',
    scan_history_label:'Scan History', scan_history_empty:'No scans yet.',
    scan_how_title:'How it works',
    scan_step1:'Photograph the supplier invoice',
    scan_step2:'AI extracts product names and prices',
    scan_step3:'Review the changes',
    scan_step4:'Confirm to update all recipes',
    scan_upload_title:'Tap to scan invoice', scan_upload_sub:'Camera or file',
    scan_ai_badge:'AI Scan', tab_scan_badge:'AI',
  ...
  ru: {
    ...
    inv_processing_title:'AI читає накладну…',
    inv_review_sub:'Перевірте виявлені зміни цін',
    inv_review_disclaimer:'AI може помилятися. Перевірте ціни перед підтвердженням.',
    inv_col_product:'Продукт', inv_col_old:'Стара ціна',
    inv_col_new:'Нова ціна', inv_col_change:'Зміна',
    inv_stat_updated:'Цін оновлено', inv_stat_last:'Останнє',
    inv_old_price:'Стара ціна', inv_new_price:'Нова ціна', inv_change:'Зміна',
    inv_processing:'AI читає накладну…',
    scan_processing_title:'AI читає накладну…',
    scan_processing_sub:'Це займе кілька секунд',
    scan_result_title:'Накладну оброблено',
    scan_result_items_found:' змін цін виявлено',
    scan_col_product:'Продукт', scan_col_old:'Було', scan_col_new:'Стало', scan_col_diff:'Різниця',
    scan_confirm_btn:'Підтвердити та оновити все', scan_cancel_btn:'Скасувати',
    scan_select_all:'Вибрати всі зміни',
    scan_disclaimer:'AI може помилятися. Перевірте ціни.',
    scan_history_label:'Історія сканувань', scan_history_empty:'Немає сканувань.',
    scan_how_title:'Як це працює',
    scan_step1:'Сфотографуйте накладну постачальника',
    scan_step2:'AI витягує назви та ціни',
    scan_step3:'Перевірте зміни',
    scan_step4:'Підтвердіть оновлення всіх рецептів',
    scan_upload_title:'Натисніть для сканування', scan_upload_sub:'Камера або файл',
    scan_ai_badge:'AI Скан', tab_scan_badge:'AI',
    ...
    inv_processing_title:'AI читает накладную…',
    inv_review_sub:'Проверьте обнаруженные изменения цен',
    inv_review_disclaimer:'AI может ошибаться. Проверьте цены перед подтверждением.',
    inv_col_product:'Продукт', inv_col_old:'Старая цена',
    inv_col_new:'Новая цена', inv_col_change:'Изменение',
    inv_stat_updated:'Цен обновлено', inv_stat_last:'Последнее',
    inv_old_price:'Старая цена', inv_new_price:'Новая цена', inv_change:'Изменение',
    inv_processing:'AI читает накладную…',
    scan_processing_title:'AI читает накладную…',
    scan_processing_sub:'Это займёт несколько секунд',
    scan_result_title:'Накладная обработана',
    scan_result_items_found:' изменений цен обнаружено',
    scan_col_product:'Продукт', scan_col_old:'Было', scan_col_new:'Стало', scan_col_diff:'Разница',
    scan_confirm_btn:'Подтвердить и обновить всё', scan_cancel_btn:'Отмена',
    scan_select_all:'Выбрать все изменения',
    scan_disclaimer:'AI может ошибаться. Проверьте цены.',
    scan_history_label:'История сканов', scan_history_empty:'Нет сканов.',
    scan_how_title:'Как это работает',
    scan_step1:'Сфотографируйте накладную поставщика',
    scan_step2:'AI извлекает наименования и цены',
    scan_step3:'Проверьте изменения',
    scan_step4:'Подтвердите обновление всех рецептов',
    scan_upload_title:'Нажмите для сканирования', scan_upload_sub:'Камера или файл',
    scan_ai_badge:'AI Скан', tab_scan_badge:'AI',
  ...
  ua: {
    ...
    /* ── P/F Library ── */
    pf_library_title:'Бібліотека П/Ф',
    pf_library_subtitle:'Всі ваші напівфабрикати з актуальною собівартістю за кг',
    btn_new_pf:'Новий П/Ф',
    btn_edit_pf:'Редагувати',
    pf_cost_per_kg:'Собівартість/кг',
    pf_used_in:'Використовується в',
    ...
    inv_title:'AI Сканер накладних',
    inv_subtitle:'Сфотографуйте накладну постачальника — AI зчитає ціни і оновить базу',
    btn_scan_invoice:'Сканувати накладну',
    inv_stat_scans:'Сканувань',
    inv_stat_updated:'Цін оновлено',
    inv_stat_last:'Останнє',
    inv_step1:'Сфотографуйте накладну постачальника',
    inv_step2:'AI розпізнає назви продуктів та нові ціни',
    inv_step3:'Перевірте зміни та підтвердіть оновлення',
    inv_history_empty:'Ще немає сканувань — натисніть золоту кнопку.',
    inv_processing_title:'AI читає накладну…',
    inv_processing_sub:'Це займе кілька секунд',
    inv_review_title:'Накладну оброблено',
    inv_review_sub:'Перевірте виявлені зміни цін',
    ...
    inv_cancel_btn:'Скасувати',
    inv_disclaimer:'AI може помилятися. Перевірте ціни перед підтвердженням.',
    inv_summary_prefix:'Знайдено',
    inv_summary_up:'підвищень',
    inv_summary_down:'знижень',
    inv_summary_avg:'Середня зміна:',
    inv_prices_updated:'цін оновлено в усіх рецептах',
    inv_prices_updated_short:'цін оновлено',
    inv_view_scan:'Переглянути',
    inv_col_product:'Продукт',
    inv_col_old:'Стара ціна',
    inv_col_new:'Нова ціна',
    inv_col_change:'Зміна',
    inv_old_price:'Стара ціна',
    inv_new_price:'Нова ціна',
    inv_change:'Зміна',
    scan_processing_title:'AI читає накладну…',
    scan_processing_sub:'Це займе кілька секунд',
    scan_result_title:'Накладну оброблено',
    scan_result_items_found:' змін цін виявлено',
    scan_col_product:'Продукт',
    scan_col_old:'Було',
    scan_col_new:'Стало',
    scan_col_diff:'Різниця',
    scan_confirm_btn:'Підтвердити та оновити все',
    scan_cancel_btn:'Скасувати',
    scan_select_all:'Вибрати всі зміни',
    scan_disclaimer:'AI може помилятися. Перевірте ціни.',
    scan_history_label:'Історія сканувань',
    scan_history_empty:'Немає сканувань.',
    scan_ai_badge:'AI Скан',
    tab_scan_badge:'AI',
    fab_scan_label:'Скан',
    tab_market:'Маркет / Прайс',
    tab_pro_badge:'PRO',
...
function switchTab(tab) {
  ...
  // ── Scan FAB: only visible on the Invoices tab (mobile only) ──
  _syncScanFabVisibility(tab);
...
/** Show scan FAB only on Invoices tab, and only on mobile (CSS hides it on desktop) */
function _syncScanFabVisibility(tab) {
  const fab = document.getElementById('scanFab');
  if (!fab) return;
  // On mobile: show only for invoices tab. CSS @media(min-width:768px) hides it on desktop.
